<div class="footer-main">
    <div class="footer-cont">
        <div class="footer-content">
            <img src="./assets/images/hackify.png" alt="" height="18%" style="margin-bottom: 20px;">
            <p class="text">Providing you with world-class Cyber-Security Solutions.<br>We are focused on creating a safer cyberspace for you and for businesses to thrive.</p>
            <p class="text">© 2021 Hackify. All Right Reserved</p>
        </div>
